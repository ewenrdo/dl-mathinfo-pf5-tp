...
```bash
utop -init <nom_du_fichier>.ml
```

ou bien directement dans l'interpréteur UTOP avec la commande `#use "<nom_du_fichier>.ml";;`.

> [!TIP]
> Pour fermer UTOP, il faut utiliser la commande `#quit;;` ou `Ctrl+D`.